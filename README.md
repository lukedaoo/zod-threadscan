...
- Learn thread creation and management in C++
- Practice synchronization, work distribution, and file scanning
...
```sh
./threadscan --no-console --path /home/user/docs --word "TODO" --num-of-files 0 --num-of-threads 8
```
